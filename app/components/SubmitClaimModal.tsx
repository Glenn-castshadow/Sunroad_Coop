      ...
      <div className="relative w-full max-w-md bg-[#1e2028] border border-white/10 rounded-tl-2xl rounded-br-2xl rounded-tr-none rounded-bl-none shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
          ...
          {fund && balanceAfter !== null && (
            <div className="bg-[#22242c] border border-white/8 rounded-tl-lg rounded-br-lg rounded-tr-none rounded-bl-none p-3">
              ...
              <div className="h-1.5 bg-white/5 rounded-full overflow-hidden flex">
                <div className="h-full" style={{ width: `${Math.round((fund.claimedYTD / fund.accruedBalance) * 100)}%`, backgroundColor: "#eab308" }}/>
                <div className="h-full" style={{ width: `${Math.round((fund.pendingClaims / fund.accruedBalance) * 100)}%`, backgroundColor: "#a69f95" }}/>
        ...
        <div className="border-t border-white/8 px-6 py-4 flex items-center justify-between bg-[#1a1c23] shrink-0">
          ...
          <button
            ...
            className="px-5 py-2 bg-green-800 hover:bg-green-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-tl-lg rounded-br-lg rounded-tr-none rounded-bl-none transition-colors flex items-center gap-2"
          >
